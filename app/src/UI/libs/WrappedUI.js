...
export class Color {
  ...
  toStyleRule() {
    ...
    return alpha === 1.0 ? `rgb(${components})` :
  ...
  static fromHex(str) {
    const regex = new RegExp(Color.Format.hex, "i"),
      ...
      error = new ColorParsingError(`Cannot parse ${str} using hex format`);

    if (match === null || match.groups === undefined) { throw error; }

    let groups = match.groups,
      red = groups.shortRed,
      green = groups.shortGreen,
      blue = groups.shortBlue,
      alpha = "ff";

    if (red !== undefined && green !== undefined && blue !== undefined) { if (
        groups.shortAlpha !== undefined) { alpha = groups
        .shortAlpha; } } else if (groups.fullRed !== undefined && groups
      .fullGreen !== undefined && groups.fullBlue !== undefined) {
      red = groups.fullRed;
    ...
    return new Color(parseInt(red.padStart(2, red), 16), parseInt(green
        .padStart(2, green), 16), parseInt(blue.padStart(2, blue), 16),
      Number(parseInt(alpha.padStart(2, alpha), 16) / 255));
  }
  ...
  static fromRGB(str) {
    ...
    if (match === null || match.groups ===
      undefined) { throw new ColorParsingError(
          `Cannot parse ${str} using rgb(a) format`); }

    let groups = match.groups,
      alphaComponent = 1.0;
    if (groups.alpha !== undefined) { alphaComponent = Number(groups.alpha); }

    return new Color(parseInt(groups.red), parseInt(groups.green), parseInt(
      groups.blue), alphaComponent);
  }
...
class Shadow {
  ...
  toStyleRule() {
    ...
    if (offsetX === undefined) { throw new Error(
        "Cannot provide a style rule withou offsetX"); }
    if (offsetY === undefined) { throw new Error(
        "Cannot provide a style rule withou offsetY"); }
  ...
  static fromStyleRule(str) {
    if (View._propertyIsSet(str) === false) { throw new Error(
        "Cannot parse data from unset property"); }

    const color = Color.fromStyleRule(str),
      constraints = View._deriveConstrains(str),
...
export class BoxShadow extends Shadow {
  constructor(offsetX, offsetY, color, blurRadius, spreadRadius, inset =
  false) {
  ...
  static fromStyleRule(str) {
    const shadow = Shadow.fromStyleRule(str),
      inset = str.includes("inset"),
      constraints = View._deriveConstrains(str);
    let spreadRadius;
    if (constraints.length > 3) { spreadRadius = constraints[constraints
        .length - 1]; }

    return new BoxShadow(shadow.offsetX, shadow.offsetY, shadow.color, shadow
      .blurRadius, spreadRadius, inset);
  }
}
...
export class Corners extends Stylable {
  ...
  toStyle() {
    ...
    if (topLeft !== undefined && topLeft === topRight && topRight ===
      bottomLeft && bottomLeft === bottomRight) {
      style.borderRadius = topLeft.radius;
    } else {
      if (topLeft !== undefined) { style.borderTopLeftRadius = topLeft
        .radius; }
      if (topRight !== undefined) { style.borderTopRightRadius = topRight
          .radius; }
      if (bottomLeft !== undefined) { style.borderBottomLeftRadius =
          bottomLeft.radius; }
      if (bottomRight !== undefined) { style.borderBottomRightRadius =
          bottomRight.radius; }
    }
  ...
  static fromStyle(style) {
    const borderRadius = style.borderRadius,
      topLeftCornerRadius = style.borderTopLeftRadius,
      topRightCornerRadius = style.borderTopRightRadius,
      bottomLeftCornerRadius = style.borderBottomLeftRadius,
      bottomRightCornerRadius = style.borderBottomRightRadius;
    ...
    if (View._propertyIsSet(topLeftCornerRadius) === true) { corners.topLeft =
        new RoundedCorner(topLeftCornerRadius); }
    if (View._propertyIsSet(topRightCornerRadius) === true) { corners
        .topRight = new RoundedCorner(topRightCornerRadius); }
    if (View._propertyIsSet(bottomLeftCornerRadius) === true) { corners
        .bottomLeft = new RoundedCorner(bottomLeftCornerRadius); }
    if (View._propertyIsSet(bottomRightCornerRadius) === true) { corners
        .bottomRight = new RoundedCorner(bottomRightCornerRadius); }

    return corners;
  }

  equals(value) {
    return this.topLeft === value.topLeft && this.topRight === value
      .topRight && this.bottomLeft === value.bottomLeft && this
...
export class Inset extends Stylable {
  ...
  equals(value) {
    return value.left === this.left && value.right === this.right && value
      .top === this.top && value.bottom === this.bottom;
  }
}
...
export class Margin extends Inset {
  ...
  static fromStyle(style) {
    return new Margin(style.marginTop, style.marginLeft, style.marginRight,
      style.marginBottom);
  }
...
export class Padding extends Margin {
  static fromStyle(style) {
    ...
    return new Padding(style.paddingTop, style.paddingLeft, style
...
export class Borders extends Inset {
  toStyle() {
    ...
    if (top !== undefined && left === right && right === top && top ===
      bottom) {
      ...
      if (left !== undefined) {
        ...
        if (borderColor !== undefined) { style.borderLeftColor = borderColor
            .toStyleRule(); }
        if (borderStyle !== undefined) { style.borderLeftStyle =
          borderStyle; }
        if (borderWidth !== undefined) { style.borderLeftWidth =
          borderWidth; }
      }
      if (right !== undefined) {
        const borderColor = right.color,
          borderStyle = right.style,
          borderWidth = right.width;

        if (borderColor !== undefined) { style.borderRightColor = borderColor
            .toStyleRule(); }
        if (borderStyle !== undefined) { style.borderRightStyle =
          borderStyle; }
        if (borderWidth !== undefined) { style.borderRightWidth =
          borderWidth; }
      }
      if (top !== undefined) {
        const borderColor = top.color,
        ...
        if (borderColor !== undefined) { style.borderTopColor = borderColor
            .toStyleRule(); }
      ...
      if (bottom !== undefined) {
        const borderColor = bottom.color,
          ...
          borderWidth = bottom.width;

        if (borderColor !== undefined) { style.borderBottomColor = borderColor
            .toStyleRule(); }
        if (borderStyle !== undefined) { style.borderBottomStyle =
          borderStyle; }
        if (borderWidth !== undefined) { style.borderBottomWidth =
          borderWidth; }
      }
    }
  ...
  static _deriveBorder(color, width, style) {
    ...
    if (View._propertyIsSet(color) === true) { borderColor = Color
        .fromStyleRule(color); }
    ...
    if (borderColor !== undefined || borderWidth !== undefined ||
      borderStyle !== undefined) { return new Border(borderColor, borderWidth,
        borderStyle); }
    return undefined;
  }
  ...
  static fromStyle(style) {
    ...
    const borderColor = style.borderColor,
      ...
      commonBorder = Borders._deriveBorder(borderColor, borderWidth,
        borderStyle);
    ...
    leftBorder = Borders._deriveBorder(style.borderLeftColor, style
      .borderLeftWidth, style.borderLeftStyle);
    if (leftBorder !== undefined) { borders.left = leftBorder; }

    rightBorder = Borders._deriveBorder(style.borderRightColor, style
      .borderRightWidth, style.borderRightStyle);
    if (rightBorder !== undefined) { borders.right = rightBorder; }

    topBorder = Borders._deriveBorder(style.borderTopColor, style
      .borderTopWidth, style.borderTopStyle);
    if (topBorder !== undefined) { borders.top = topBorder; }

    bottomBorder = Borders._deriveBorder(style.borderBottomColor, style
      .borderBottomWidth, style.borderBottomStyle);
...
export class View extends Observable {
  ...
  get overflow() {
    const overflow = this.node.style.overflow,
      values = Object.values(View.Overflow),
      value = values.find(value => value === overflow);
  ...
  get position() {
    const position = this.node.style.position,
      values = Object.values(View.Position),
      value = values.find(value => value === position);
    if (value === undefined) { throw new Error(
  ...
  get backgroundColor() {
    ...
    if (View._propertyIsSet(backgroundColor) === true) { return Color
        .fromStyleRule(backgroundColor); }
    return undefined;
  }
  ...
  get color() {
    ...
    if (View._propertyIsSet(color) === true) { return Color.fromStyleRule(
        color); }
    return undefined;
  }
   ...
   */
  _prepareView(view) {
    if (view.parentView !== undefined) { throw new Error(
        "Cannot add view to more than one parent view"); }
  ...
  static _deriveConstrains(str) {
    const regex = new RegExp(
        "[+-]?\\d+(?:\\.\\d+)?(?:%|vmax|vmin|vh|vw|rem|ch|ex|em|cm|mm|in|px|pt|pc)",
        "g"),
...
export class GaussianBlurFilter extends Stylable {
  ...
  static fromStyle(style) {
    if (View._propertyIsSet(this.filter) === false || this.filter.includes(
        "blur") === false) { return undefined; }

    const filter = style.filter,
      constraints = View._deriveConstrains(filter);
    if (constraints.left !== 1) { throw new Error(
        `Cannot derive gaussian blur from rule ${filter}`); }
...
export class GridInset extends Inset {
  static fromStyle(style) {
    return new GridInset(style.gridRowStart, style.gridColumnStart, style
      .gridColumnEnd, style.gridRowEnd);
  }
...
export class StackView extends View {
  ...
  constructor(axis = StackView.Axis.vertical, mainAxisAlignment = StackView
    .MainAxisAlignment.flexStart, crossAxisAlignment = StackView
    .CrossAxisAlignment.stretch, gap = Gap.unset, direction = StackView
    .Direction.default, wrap = StackView.Wrap.none, wrapCrossAxisAlignment =
    StackView.WrapCrossAxisAlignment.default) {
    super();
  ...
  get axis() {
    ...
    if (this.node.style.flexDirection.startsWith(vertical) ===
      true) { return vertical; }
  ...
  get direction() {
    ...
    if (this.node.style.flexDirection.endsWith(reverse) ===
      true) { return reverse; }
  ...
  set direction(value) {
    const node = this.node,
      reverse = StackView.Direction.reversed;
  ...
  get wrap() {
    const wrap = this.node.style.flexWrap,
      values = Object.values(StackView.Wrap),
      value = values.find(value => value === wrap);
  ...
  get mainAxisAlignment() {
    const alignment = this.node.style.justifyContent,
      values = Object.values(StackView.MainAxisAlignment),
      value = values.find(value => value === alignment);
    if (value === undefined) { throw new Error(
        `Unsupported main axis alignment: ${alignment}`); }
  ...
  get crossAxisAlignment() {
    const alignment = this.node.style.alignItems,
      values = Object.values(StackView.CrossAxisAlignment),
      value = values.find(value => value === alignment);
    if (value === undefined) { throw new Error(
        `Unsupported cross axis alignment: ${alignment}`); }
  ...
  get wrapCrossAxisAlignment() {
    const alignment = this.node.style.alignContent,
      values = Object.values(StackView.WrapCrossAxisAlignment),
      value = values.find(value => value === alignment);
    if (value === undefined) { throw new Error(
        `Unsupported wrap cross axis alignment: ${alignment}`); }
  ...
  get crossAxisSelfAlignment() {
    const alignment = this.node.style.alignSelf,
      values = Object.values(StackView.CrossAxisSelfAlignment),
      value = values.find(value => value === alignment);
    if (value === undefined) { throw new Error(
        `Unsupported cross self axis alignment: ${alignment}`); }
...
export class Label extends View {
  ...
  get whiteSpace() {
    const whiteSpace = this.node.style.whiteSpace,
      values = Object.values(Label.WhiteSpace),
      value = values.find(value => value === whiteSpace);
    if (value === undefined) { throw new Error(
        `Unsupported whiteSpace: ${whiteSpace}`); }
  ...
  get textOverflow() {
    const textOverflow = this.node.style.textOverflow,
      values = Object.values(Label.TextOverflow),
      value = values.find(value => value === textOverflow);
    if (value === undefined) { throw new Error(
        `Unsupported textOverflow: ${textOverflow}`); }
  ...
  get fontWeight() {
    const fontWeight = this.node.style.fontWeight,
      values = Object.values(Label.FontWeight),
      value = values.find(value => value === fontWeight);
    if (value === undefined) { throw new Error(
        `Unsupported fontWeight: ${fontWeight}`); }
  ...
  get textAlignment() {
    const textAlignment = this.node.style.textAlign,
      values = Object.values(Label.TextAlignment),
      value = values.find(value => value === textAlignment);
    if (value === undefined) { throw new Error(
        `Unsupported textAlignment: ${textAlignment}`); }
...
export class TextField extends Label {
  ...
  get textInputType() {
    const textInputType = this.node.type,
      values = Object.values(TextField.TextInputType),
      value = values.find(value => value === textInputType);
    if (value === undefined) { throw new Error(
        `Unsupported textInputType: ${textInputType}`); }
  ...
  _onChangeWrapper() {
    ...
    this.notifyAll(new Event(TextField.TEXT_FIELD_CHANGE_NOTIFICATION_TYPE,
      this));
  }
  ...
  _onKeyPressWrapper() {
    ...
    this.notifyAll(new Event(TextField.TEXT_FIELD_KEYPRESS_NOTIFICATION_TYPE,
      this));
  }
  ...
  _onPasteWrapper() {
    ...
    this.notifyAll(new Event(TextField.TEXT_FIELD_PASTE_NOTIFICATION_TYPE,
      this));
  }
  ...
  _onInputWrapper() {
    ...
    this.notifyAll(new Event(TextField.TEXT_FIELD_INPUT_NOTIFICATION_TYPE,
      this));
  }
  ...
  _addListeners() {
    ...
    node.addEventListener(TextField.TEXT_FIELD_CHANGE_NOTIFICATION_TYPE, this
      ._onChangeWrapper.bind(this), true);
    node.addEventListener(TextField.TEXT_FIELD_KEYPRESS_NOTIFICATION_TYPE,
      this._onChangeWrapper.bind(this), true);
    node.addEventListener(TextField.TEXT_FIELD_PASTE_NOTIFICATION_TYPE, this
      ._onChangeWrapper.bind(this), true);
    node.addEventListener(TextField.TEXT_FIELD_INPUT_NOTIFICATION_TYPE, this
      ._onChangeWrapper.bind(this), true);
  }
...
export class Button extends Label {
  ...
  _addListeners() {
    ...
    node.addEventListener(Button.BUTTON_CLICK_NOTIFICATION_TYPE, this
      ._onClickWrapper.bind(this), true);
    node.addEventListener(Button.BUTTON_MOUSE_OUT_NOTIFICATION_TYPE, this
      ._onMouseOutWrapper.bind(this), true);
    node.addEventListener(Button.BUTTON_MOUSE_OVER_NOTIFICATION_TYPE, this
      ._onMouseOverWrapper.bind(this), true);
  }
  ...
  _onMouseOutWrapper(event) {
    ...
    this.notifyAll(new Event(Button.BUTTON_MOUSE_OUT_NOTIFICATION_TYPE,
    this));
  }
  ...
  _onMouseOverWrapper(event) {
    ...
    this.notifyAll(new Event(Button.BUTTON_MOUSE_OVER_NOTIFICATION_TYPE,
      this));
  }
}
...
export class Select extends View {
   ...
   */
  _addListeners() {
    this.node.addEventListener(Select.SELECT_ON_SELECTION_TYPE_NOTIFICATION,
      this._onSelect.bind(this), true);
  }
   ...
   */
  _onSelect() {
    this.notifyAll(new Event(Select.SELECT_ON_SELECTION_TYPE_NOTIFICATION,
      this));
  }
...
class ViewPortAnchor extends View {
  ...
  static get sharedInstance() {
    if (ViewPortAnchor._sharedInstance === undefined) { ViewPortAnchor
        ._sharedInstance = new ViewPortAnchor(); }
...
export class Controller extends Observable {
   ...
   */
  _createView() {
    const stackView = new StackView(StackView.Axis.vertical, StackView
      .MainAxisAlignment.flexStart, StackView.CrossAxisAlignment.stretch);
  ...
  addController(controller, parentView = this.view) {
    if (controller.parentController !== undefined) { throw new Error(
        "Cannot add controller to more than one parent controller"); }
  ...
  _determinePresentationState() {
    this.presentationState = this.controllers.length > 0 ? Controller
      .PresentationState.presenting : Controller.PresentationState.presented;
  }
  ...
  _onPresentationStateChange() {
    const event = new Event(Controller
      .PRESENTATION_STATE_CHANGE_NOTIFICATION_TYPE, this);
    this.notifyAll(event);
  }
